...
# Realizar inferencia por enumeración para calcular P(D|A=0, B=1)
resultado_inferencia = inferencia.query(variables=['D'], evidence=evidencia)

# Imprimir el resultado de la inferencia
print("Resultado de la inferencia por enumeración:")
